...
//    private final Pose startPose = new Pose(15.3, 110.7, Math.toRadians(180));
...
//    private final Pose intakeSecondLine = new Pose(41.5, 59, Math.toRadians(180));
//    private final Pose finishSecondLine = new Pose(13, 59, Math.toRadians(180));
//    private final Pose intakeThirdLine = new Pose(41.5, 35.7, Math.toRadians(180));
//    private final Pose finishThirdLine = new Pose(10, 35.7, Math.toRadians(180));
//    private final Pose controlGatePose = new Pose(32, 72, Math.toRadians(180));
//    private final Pose gatePose = new Pose(12, 70, Math.toRadians(180));
...
//                }
//            case 4:
//                if(pathTimer.getElapsedTimeSeconds() > 2) { //3+65
...
//        telemetry.addData("flywheel state " , shooter.state == Shooter.State.FORCE_STOP);
//        telemetry.update();
//    }
//
//    @Override
