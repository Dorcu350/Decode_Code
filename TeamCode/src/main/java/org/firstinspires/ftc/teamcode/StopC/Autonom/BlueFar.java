...
//    private final Pose startPose = new Pose(56, 8.8, Math.toRadians(90)); // x55.4
//    private final Pose scorePose = new Pose(56, 12, Math.toRadians(90));
//    private final Pose intakeLinePose = new Pose(42, 35.5, Math.toRadians(180));
//    private final Pose finalLinePose = new Pose(11, 35.5, Math.toRadians(180));
//    private final Pose scorePose180 = new Pose(50, 10, Math.toRadians(180));
//    private final Pose intakeCornerPose = new Pose(10, 10, Math.toRadians(180));
//    private final Pose intakeCornerPose2 = new Pose(10, 24, Math.toRadians(190));
//    private final Pose controlIntakeCornerPose2 = new Pose(33.9, 28.6, Math.toRadians(190));
//    private final Pose stepBackPose = new Pose(25, 10, Math.toRadians(180));
