...
public class RedCloseMax extends OpMode {
    Shooter shooter;
    Intake intake;
    Sensors sensors;
    Turret turret;
    ...
    private final Pose startPose = new Pose(13, 110.7, Math.toRadians(180)).mirror();
    ...
    private final Pose intakeSecondLine = new Pose(41.5, 60, Math.toRadians(180)).mirror();
    private final Pose finishSecondLine = new Pose(13, 60, Math.toRadians(180)).mirror();
    private final Pose intakeGate = new Pose(10, 61, Math.toRadians(160)).mirror();
    private final Pose strafeGate = new Pose(2.5, 54.6, Math.toRadians(130)).mirror();
    private final Pose controlGatePose = new Pose(32, 72, Math.toRadians(180)).mirror();
    private final Pose gatePose = new Pose(10, 68, Math.toRadians(180)).mirror();
    private final Pose controlSecond = new Pose(41.5, 35.7, Math.toRadians(180)).mirror();
    private final Pose scorePose2 = new Pose(58.7, 108, Math.toRadians(180)).mirror();
