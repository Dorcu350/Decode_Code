...
public class Far_HP_Blue extends OpMode {
    Shooter shooter;
    Intake intake;
    Sensors sensors;
    Turret turret;
    ...
    private final Pose startPose = new Pose(56, 8, Math.toRadians(90)); // x55.4
    private final Pose scorePose = new Pose(53.4, 13, Math.toRadians(90));
    private final Pose scorePose180 = new Pose(56, 8, Math.toRadians(180));
    private final Pose intakeCornerPose = new Pose(12, 8.4, Math.toRadians(180));
    private final Pose intakeCornerPose2 = new Pose(12, 14, Math.toRadians(180));
    private final Pose intakeLinePose = new Pose(12, 35.5, Math.toRadians(180));
    private final Pose controlIntakePose = new Pose(47.7,35.6, Math.toRadians(180));
