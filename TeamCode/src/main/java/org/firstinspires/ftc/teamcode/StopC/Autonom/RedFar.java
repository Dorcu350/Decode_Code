...
public class RedFar extends OpMode {
    ...
    private final Pose startPose = new Pose(85.25, 8.5, Math.toRadians(90));
    private final Pose scorePose = new Pose(83, 14, Math.toRadians(90));
    private final Pose intakeCornerPose = new Pose(132, 14, Math.toRadians(-10));
    private final Pose intakeCornerPose2 = new Pose(132, 9, Math.toRadians(0));
    private final Pose stepBackPose = new Pose(122.3, 11.6, Math.toRadians(-10));
