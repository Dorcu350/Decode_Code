...
//    private final Pose startPose = new Pose(15.3, 110.7, Math.toRadians(180)).mirror();
//    private final Pose scorePose = new Pose(51, 84.5, Math.toRadians(180)).mirror();
//    private final Pose finishFirstLine = new Pose(16, 84, Math.toRadians(180)).mirror();
//    private final Pose intakeSecondLine = new Pose(41.5, 59, Math.toRadians(180)).mirror();
//    private final Pose finishSecondLine = new Pose(13, 59 , Math.toRadians(180)).mirror();
//    private final Pose intakeThirdLine = new Pose(41.5, 35.7, Math.toRadians(180)).mirror();
//    private final Pose finishThirdLine = new Pose(10, 35.7, Math.toRadians(180)).mirror();
//    private final Pose controlGatePose = new Pose(32, 72, Math.toRadians(180)).mirror();
//    private final Pose gatePose = new Pose(12, 70, Math.toRadians(180)).mirror();
//    private Path scorePreload, grabFirst, goOpen, scoreFirst, grabSecond, finishSecond, scoreSecond, grabThird, finishThird, scoreThird, park;
//
...
//
//        goOpen = new Path(new BezierCurve(finishFirstLine, controlGatePose , gatePose));
//        goOpen.setConstantHeadingInterpolation(gatePose.getHeading());
//
//        scoreFirst = new Path(new BezierLine(gatePose, scorePose));
...
//
//        scoreSecond = new Path(new BezierLine(finishSecondLine, scorePose));
//        scoreSecond.setLinearHeadingInterpolation(finishSecondLine.getHeading() ,scorePose.getHeading());
//
//        scoreThird = new Path(new BezierLine(finishThirdLine, scorePose));
//        scoreThird.setConstantHeadingInterpolation(scorePose.getHeading());
//
