...
public class Close_Aicit_Blue extends OpMode {
    Shooter shooter;
    Intake intake;
    Sensors sensors;
    Turret turret;
    ...
    private final Pose scorePose = new Pose(47.9, 84, Math.toRadians(180));
    private final Pose controlPose = new Pose(40.7, 105.7, Math.toRadians(180));
    private final Pose finishFirstLine = new Pose(18, 84, Math.toRadians(180));
    ...
    private final Pose intakeThirdLine = new Pose(44, 35.5, Math.toRadians(180));
    private final Pose finishThirdLine = new Pose(9, 35.5, Math.toRadians(180));
    private final Pose openGatePose = new Pose(11, 65.6, Math.toRadians(270));
    private final Pose controlGatePose = new Pose(21.8, 51.3, Math.toRadians(270));
    private final Pose scorePose2 = new Pose(47.9, 84, Math.toRadians(240));
    private final Pose firstHPPose = new Pose(20, 10.6, Math.toRadians(260));
    private final Pose secondHPPose = new Pose(13, 9.6, Math.toRadians(260));
    private final Pose thirdHPPose = new Pose(8, 7, Math.toRadians(270));
    private final Pose controlThirdHP = new Pose(3.4, 66.1, Math.toRadians(270));
    private final Pose scorePose3 = new Pose(56, 100, Math.toRadians(240));
